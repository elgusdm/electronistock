-- Base de datos para componentes electrónicos

CREATE DATABASE componentes_electronicos;
USE componentes_electronicos;
...
-- Tabla de relación componentes-proveedores (muchos a muchos)
...
-- Crear procedimiento almacenado para búsqueda
DELIMITER //
